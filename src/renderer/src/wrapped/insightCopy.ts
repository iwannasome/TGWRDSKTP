...
const INSIGHT_DESCRIPTIONS: Record<ConversationInsightKind, string> = {
  ...
  night_companion: 'Чат минимум с 3 000 сообщений, где ночная доля заметно выше ритма остальных личных диалогов.',
  day_anchor: 'Чат минимум с 3 000 сообщений, где дневная доля заметно выше ритма остальных личных диалогов.',
  alive_dialog: 'Крупный диалог с самой высокой живостью: плотность сообщений внутри активных сессий.',
  longest_live_session: 'Самая длинная плотная сессия в крупном диалоге и в пределах 12 часов: учитываются разрывы, объем и участие обеих сторон.',
  ...
  media_bond: 'Крупный чат с достаточным объемом медиа, чья доля фото, видео, голосовых, стикеров или файлов выше остальных диалогов.'
}
