...
const INSIGHT_DESCRIPTIONS: Record<ConversationInsightKind, string> = {
  ...
  contact_initiator: 'Кто чаще запускал активные дни переписки, когда таких дней достаточно.',
  silence_restarter: 'Кто чаще возвращал разговор после значимых пауз.',
