...
export default function Slide10IgnoredMostPerson({ report, period }: SlideCommonProps): JSX.Element {
  const p = getPeriod(report, period)
  const champ = getReplyChampion(p, 'who_you_ignore_most')

  return (
    <SlideFrame kicker="Replies" title="Кого игнорируешь дольше всех" subtitle="Максимальная медиана ответа." >
