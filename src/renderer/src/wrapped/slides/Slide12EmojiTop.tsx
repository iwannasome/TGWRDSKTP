...
export default function Slide12EmojiTop({ report, period, exporting }: SlideCommonProps): JSX.Element {
  ...
  return (
    <SlideFrame
      kicker="TGWR Emoji"
      title={<span className="tgwr-gradient-text font-semibold">Эмодзи</span>}
      subtitle="Короткие реакции, которые чаще всего появлялись в твоих сообщениях."
    >
            ...
            <div className="grid grid-cols-4 gap-6">
              {emojis.map((e, idx) => (
                <div
                  ...
                  className="tgwr-info-card tgwr-hover-card rounded-[24px] border border-white/10 bg-[rgba(var(--tgwr-surface-rgb),0.46)] px-6 py-6"
                >
