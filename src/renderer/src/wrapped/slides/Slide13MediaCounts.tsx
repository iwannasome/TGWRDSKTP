...
export default function Slide13MediaCounts({ report, period, exporting }: SlideCommonProps): JSX.Element {
  ...
  return (
    <SlideFrame
      kicker="TGWR Media"
      title={<span className="tgwr-gradient-text font-semibold">Медиа в чатах</span>}
      subtitle="Фото, видео, голосовые, стикеры и файлы — все, чем переписки становятся живыми."
    >
      <div className="flex h-full flex-col justify-center">
        <div className="tgwr-telegram-panel rounded-[30px] p-10">
            ...
            {ITEMS.map((it, idx) => {
              ...
              return (
                <div
                  ...
                  className="tgwr-info-card tgwr-hover-card rounded-[24px] border border-white/10 bg-[rgba(var(--tgwr-surface-rgb),0.46)] px-7 py-6"
                >
